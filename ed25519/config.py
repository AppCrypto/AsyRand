...
import cliconfig
from ed25519 import Point, Scalar, KeyPair
...
def load_config(n=None):
    ...
    import merkle
    from data import ShareCorrectnessProof, NodeInfo
...
logging.debug(f"use cli config: {cliconfig.USE_CLI_CONFIG}")
